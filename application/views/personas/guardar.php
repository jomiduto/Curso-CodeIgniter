...
<body>
	...
	<div class="container">
		...
		<br>
		<a href="<?php echo base_url()//URL BASE ?>personas/listado" class="btn btn-success">Regresar</a> <!-- Guardar es el nombre de la funcion -->
		<br>
		<br>
		...
		<?php echo form_open(''); ?>
			...
			<?php 
				...
				/*
				Primer paramero "mysubmit" aparece en el name
				Segundo parametro "Enviar" texto del boton
				Tercer parametro, son los estilos que se agregan al boton, tambien id y clases
				*/
			?>
